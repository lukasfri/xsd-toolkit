...
use xsd_fragments::{
    transformers::{
        context::complex::{ExpandIncludeFragments, ExpandRedefineFragments},
        TransformChange,
    },
    XmlnsContext,
};
...
#[rstest]
#[case::include_and_redefine(
    "bug_tests/include_and_redefine/root.xsd",
    "bug_tests/include_and_redefine/result.xsd",
    TransformChange::Changed
)]
#[case::redefine_only(
    "bug_tests/include_and_redefine/top.xsd",
    "bug_tests/include_and_redefine/result_only_redefine.xsd",
    TransformChange::Unchanged
)]
fn test(
    #[case] path: &str,
    #[case] result: &str,
    #[case] include_expected_change: TransformChange,
) {
    use xsd::xs;
    ...
    assert_eq!(changed, include_expected_change);
