...
pub struct Schema {
    ...
    pub default_attributes: Option<ExpandedName<'static>>,
...
pub struct GroupType {
    ...
    pub ref_: Option<ExpandedName<'static>>,
...
pub type TargetNamespace = XmlNamespace<'static>;
...
pub struct LocalElement {
    ...
    pub name: Option<Name>,
    pub ref_: Option<ExpandedName<'static>>,
    pub type_: Option<ExpandedName<'static>>,
    pub substitution_group: Vec<ExpandedName<'static>>,
    pub min_occurs: Option<MinOccurs>,
    pub max_occurs: Option<MaxOccursValue>,
...
pub struct List {
    ...
    pub annotation: Option<Annotation>,
    pub simple_type: Option<LocalSimpleType>,
    pub item_type: Option<ExpandedName<'static>>,
}
...
pub struct Union {
    ...
    pub member_types: Option<Vec<ExpandedName<'static>>>,
}
...
#[derive(Debug, Clone, Eq, PartialEq)]
pub struct Refer(pub ExpandedName<'static>);
